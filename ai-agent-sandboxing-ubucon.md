...
section.opening {
  background: url('../assets/image-opening-ubucon.jpg') center / cover no-repeat;
  border-left: none;
  justify-content: flex-start;
}
...
section.closing {
  background: url('../assets/image-closing-ubucon.jpg') center / cover no-repeat;
  border-left: none;
  color: #ffffff;
  display: block;
  padding: 0;
